...
def checkout_project(github_token_secret: str) -> steps.Git:
...
def nix_eval_config(
    ...
    factory.addStep(checkout_project(github_token_secret))
...
def buildbot_effects_config(
    project: GithubProject, github_token_secret: str, worker_names: list[str]
) -> util.BuilderConfig:
    """Builds one nix flake attribute."""
    factory = util.BuildFactory()
    url_with_secret = util.Interpolate(
